...
/**
 * <b> 역할: {@link UserSignInInputPortRequestDTO} 클래스 단위 테스트 클래스 </b>
 */
public class UserSignInInputPortRequestTest {

    /**
     * <b> 역할: {@link UserSignInInputPortRequestDTO} 기본 생성자 테스트 메소드 </b>
     * <p>
    ...
    public void testNoArgsConstructor() {
        UserSignInInputPortRequest dto = new UserSignInInputPortRequestDTO();
        assertNull(dto.getId(), "ID 필드는 null이어야 합니다.");
        assertNull(dto.getPw(), "PW 필드는 null이어야 합니다.");
    }

    /**
     * <b> 역할: {@link UserSignInInputPortRequestDTO} 모든 필드를 초기화하는 생성자 테스트 메소드 </b>
     * <p>
    ...
    public void testAllArgsConstructor() {
        UserSignInInputPortRequest dto = new UserSignInInputPortRequestDTO("user123", "password123");
        assertEquals("user123", dto.getId(), "ID 필드가 초기화된 값과 일치해야 합니다.");
        assertEquals("password123", dto.getPw(), "PW 필드가 초기화된 값과 일치해야 합니다.");
    }

    /**
     * <b> 역할: {@link UserSignInInputPortRequestDTO} 필드의 Getter 및 Setter 테스트 메소드 </b>
     * <p>
