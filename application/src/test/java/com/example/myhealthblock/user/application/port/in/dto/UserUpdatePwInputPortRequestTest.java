...
/**
 * <b> 역할: {@link UserUpdatePwInputPortRequestDTO} 클래스 단위 테스트 클래스 </b>
 */
public class UserUpdatePwInputPortRequestTest {

    /**
     * <b> 역할: {@link UserUpdatePwInputPortRequestDTO} 기본 생성자 테스트 메소드 </b>
     * <p>
    ...
    public void testNoArgsConstructor() {
        UserUpdatePwInputPortRequest dto = new UserUpdatePwInputPortRequestDTO();
        assertNull(dto.getOldPw(), "OldPw 필드는 null이어야 합니다.");
        assertNull(dto.getNewPw(), "NewPw 필드는 null이어야 합니다.");
    }

    /**
     * <b> 역할: {@link UserUpdatePwInputPortRequestDTO} 모든 필드를 초기화하는 생성자 테스트 메소드 </b>
     * <p>
    ...
    public void testAllArgsConstructor() {
        UserUpdatePwInputPortRequest dto = new UserUpdatePwInputPortRequestDTO("oldpassword123", "newpassword123");
    ...
    /**
     * <b> 역할: {@link UserUpdatePwInputPortRequestDTO} 필드의 Getter 및 Setter 테스트 메소드 </b>
     * <p>
