...
public class OpinionController {
    private final OpinionInputPort opinionInputPort;
     ...
     * @return 여러 의견
     */
    private OpinionInputPortDTO[] getOpinionDTOs(Integer questionId, Integer userId) {
        OpinionInputPortDTO[] list = null;
        if (userId != null) {
            list = opinionInputPort.getOpinionsByUserId(userId);
        } else if (questionId != null){
            list = opinionInputPort.getOpinionsByQuestionId(questionId);
        }
        return list;
    }
